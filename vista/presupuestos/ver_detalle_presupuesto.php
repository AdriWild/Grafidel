...
require_once '/../../php/objects/Categoria.php';
...
?>
    ...
    <tr>
    	<td colspan="2">Descargar presupuesto:</td><td colspan="2"><a href="../gen_pdf/presupuesto/etiqueta_impresa_pdf.php?presupuesto_Id=<?php echo $presupuesto->presupuesto_Id; ?>" target="_blank"><img src="../img/iconos/pdf_icon.png" width="18" height="18" alt=""/></a></td>
    </tr>
</table>